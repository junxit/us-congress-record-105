---
granule: CREC-1997-01-09-pt1-PgH103
date: 1997-01-09
edition: CREC
section: HOUSE
page: H103
citation: 143 Cong. Rec. H103
---
...
---------------------------------------------------------------------------
     \2\ An example of one technical or nomenclature change that 
...
[[Page H134]]
  ...
  I. Slip Resistant Surfaces-- Aisles, Steps, Floor Area where People 
    Walk, Floor Areas in Securement Locations, Lift Platforms, Ramps
     ...
     Contrast=[(B<INF>1</INF>-B<INF>2</INF>)/B<INF>1</INF>]100
     Where B<INF>1</INF>=light reflectance value (LRV) of the 
         lighter area and B<INF>2</INF>=light reflectance value 
         (LRV) of the darker area.
       Note that in any application both white and black are never 
     absolute; thus, B<INF>1</INF> never equals 100 and 
     B<INF>2</INF> is always greater than 0.
